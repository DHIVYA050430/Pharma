...
home.html
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>DESIGNED AND DEVELOPED BY DIVYA E(212223230050)</p>
  </footer>
...
<body>
  ...
  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>DESIGNED AND DEVELOPED BY DIVYAE(212223230050)</p>
  </footer>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="PRODUCT 1.jpg" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="PRODUCT 2.jpg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="PRODUCT3.webp" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
...
![alt text](about.html.png)
![alt text](contact.html.png)
![alt text](product.html.png)
## RESULT:
